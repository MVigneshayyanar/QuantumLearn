  ...
  messages: [
    {
      id: 'welcome-msg',
      role: 'assistant',
      content: "Hello! I'm your Socratic Quantum Tutor. As you build circuits or explore algorithms, feel free to ask questions. If you get stuck on a quiz or wonder why a qubit behaves a certain way, I'll guide you step-by-step through the physics!",
      timestamp: Date.now()
    }
  ],
  isGenerating: false,
