...
export interface AlgorithmMeta {
  slug: AlgorithmSlug | 'all';
  label: string;
  shortLabel: string;
  description: string;
}

export const ALGORITHM_OPTIONS: AlgorithmMeta[] = [
  { slug: 'all', label: 'All Algorithms', shortLabel: 'All', description: 'Browse all quantum practice problems' },
  { slug: 'deutsch-jozsa', label: 'Deutsch-Jozsa', shortLabel: 'Deutsch-Jozsa', description: 'Quantum parallelism & oracle discrimination' },
  { slug: 'grover', label: "Grover's Search", shortLabel: 'Grover', description: 'Amplitude amplification & phase inversion' },
  { slug: 'teleportation', label: 'Quantum Teleportation', shortLabel: 'Teleportation', description: 'Entanglement-based quantum state transfer' },
  { slug: 'superdense-coding', label: 'Superdense Coding', shortLabel: 'Superdense', description: 'Transmitting 2 classical bits via 1 entangled qubit' },
  { slug: 'foundations', label: 'Foundations & Gates', shortLabel: 'Foundations', description: 'Core 1-qubit states, rotations & circuit identities' }
];
